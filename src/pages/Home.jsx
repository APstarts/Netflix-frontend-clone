      ...
      <div className="relative h-120 w-full after:absolute after:inset-0 after:bg-linear-to-t after:from-black/30 after:to-transparent">
        ...
        <div className="absolute bottom-10 left-10 z-10 flex flex-col gap-2">
          <div className="flex gap-2">
            ...
            <button className="font-bold cursor-pointer border-red-600 border-2  p-2 bg-red-600 text-white hover:scale-110 duration-300">
              Add to watchlist
            </button>
          </div>
          <div>
            <p>
              Luffy, the kid who grew up with a dream to become the next Pirate
              King. Watch how his adventure goes.
            </p>
          </div>
        </div>
      </div>
      <p className="ml-5 mt-2 font-bold text-2xl">New Releases</p>
      <div className="flex gap-3 mt-2 mx-5 flex-nowrap overflow-x-scroll scrollbar-hide">
        {images.map((i) => (
          <div className="flex flex-col gap-2 shrink-0">
            <img
              src={i.img}
              className="h-64 w-48 hover:scale-110 duration-300 cursor-pointer"
            />
